...
! Calculating second term within the expression
    CALL PUSHREAL4(dot_aux)
    CALL DOT(r1, r2, dot_aux)
    CALL PUSHREAL4ARRAY(cross_aux, 3)
...
! Calculating second term within the expression
    ...
    CALL POPREAL4ARRAY(cross_aux, 3)
    uinfb = 0.0
    r1b = 0.0
    CALL CROSS_B(uinf, uinfb, r1, r1b, cross_aux, cross_auxb)
    CALL POPREAL4(dot_aux)
    uinfb = 0.0
...
!   Operations
    DO ii=1,n_vort
      CALL PUSHREAL4ARRAY(x_control, 3)
...
&                   )
      END DO
      CALL POPREAL4ARRAY(x_control, 3)
